...
If the google search tool raises an error due to rate limits, then use your other tool that fetches web pages instead.
...
The current datetime is {datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M:%S")}
"""
